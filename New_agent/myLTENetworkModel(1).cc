...
static ns3::GlobalValue g_cioList ("cioList",
                                   ...
                                   ns3::StringValue("0 0 0 0 0 0"),                                     /////////////changed<<<<<<<<<<<<<<<<<<<<<
                                   ns3::MakeStringChecker());
...
int main (int argc, char *argv[])
 {
      ...
      Config::SetDefault ("ns3::ConfigStore::Filename", StringValue("LTE_Attributes.txt"));                               //changed<<<<<
...
//      double deltaEdge = doubleValue.Get ();
      ...
      //MIMO
	    //Config::SetDefault ("ns3::LteEnbRrc::DefaultTransmissionMode", UintegerValue (2)); // SISO 0 Spatial Mux 2
